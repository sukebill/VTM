...
public class CreateCharacterAbilities2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_character_abilities2);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), CreateCharacterAbilities3.class);
        ...
        setLayout("animalkenRadioButton", "ANIMALKEN");
        setLayout("craftsRadioButton", "CRAFTS");
        setLayout("driveRadioButton", "DRIVE");
        setLayout("etiquetteRadioButton", "ETIQUETTE");
        setLayout("performanceRadioButton", "PERFORMANCE");
        setLayout("firearmsRadioButton", "FIREARMS");
        setLayout("meleeRadioButton", "MELEE");
        setLayout("securityRadioButton", "SECURITY");
        setLayout("stealthRadioButton", "STEALTH");
        setLayout("survivorRadioButton", "SURVIVOR");
    }
