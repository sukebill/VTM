...
public class DisciplineRituals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        disciplineId = extras.getString(VTMApplication.getExtraDiscipline());
        discipline = extras.getString(VTMApplication.getExtraTitle());
        ritual = extras.getString(VTMApplication.getExtraRitual());
        ritualSystem = extras.getString(VTMApplication.getExtraRitualSystem());
