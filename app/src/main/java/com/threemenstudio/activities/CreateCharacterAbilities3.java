...
public class CreateCharacterAbilities3 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_character_abilities3);
        ...
        setLayout("academicsRadioButton", "ACADEMICS");
        setLayout("computersRadioButton", "COMPUTERS");
        setLayout("financeRadioButton", "FINANCE");
        setLayout("investigationRadioButton", "INVESTIGATION");
        setLayout("lawRadioButton", "LAW");
        setLayout("linguisticsRadioButton", "LINGUISTICS");
        setLayout("medicineRadioButton", "MEDICINE");
        setLayout("occultRadioButton", "OCCULT");
        setLayout("politicsRadioButton", "POLITICS");
        setLayout("scienceRadioButton", "SCIENCE");
    }
